...
// Inputs (buttons)
const int PulsadorParo = 2; //Pulsador que detiene el sistema
const int PulsadorIzquierda = 7; // Pulsador Giro Izquierda
const int PulsadorDerecha = 4; // Pulsador Giro Derecha
